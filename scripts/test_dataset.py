...
for db_type in ['roads', 'buildings', 'merged']:
    out_dir = 'test_%s' % db_type
    if not os.path.exists(out_dir):
        os.mkdir(out_dir)

    sat_db_path = 'data/mass_%s/lmdb/valid_sat' % db_type
    map_db_path = 'data/mass_%s/lmdb/valid_map' % db_type
